...
#last=4
all f:first|
f.st=-8 and no f.~n and f not in (first-f).^n
...
all f:first | f.d=inc => f.seg >2 and f.seg<6
all f:first | f.d=dec => f.seg >1 and f.seg<5
...
run p for 12 people,4 Int

/********************postcondition*******************/
fact post
{
//all l:people|l.d=inc and l.seg=6 <=> l in last 
all l:people|l.d=dec and l.seg=1 or l.d=inc and l.seg=7 <=> l in last
